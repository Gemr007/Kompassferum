...
2. На экране предметов нажать **«Показать предварительный результат»** — придут
   ...
   Плашка честно говорит, что пройдено 12 из 74 вопросов.
...
5. Показать устойчивость: остановить контейнер backend
   ...
   Без ключа OpenRouter рекомендации всё равно приходят, но с пометкой
...
Проходить все 74 вопроса ради демонстрации не нужно: как только пройден блок A
...
- **Демо-данные генерируются локально** (`app/seed.py`) — это выдуманный класс,
  а не реальные ученики.
